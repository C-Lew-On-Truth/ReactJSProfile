           ...
           <div className="entry-holder">
             ...
             <div className="bio">
               <p>
                 ...
                 reside in many locations within North America. I'm throughly "down
                 to earth" and because of all these living experiences, I have
                 groomed myself to become a well rounded specimen. My work ethic is
                 relentless, but I love to have a good time! In 2015, I packed my
                 bags and hopped on a train to New York City to seek a position in
                 the media industry! Fast forward 6 years later, I now have
                 established myself as a true media professional in transition to
